...
-- {{{ Tags
tags = {
   names = { " WEB ", " TERMINAL ", " FILE ", " OTHER "},
   layout = { layouts[1], layouts[3], layouts[4], layouts[1] }
}
...
--                                        { "Development", mydevel, beautiful.awesome_icon },
...
blue   = "#80CCE6"
space3 = markup.font("Inconsolata 3", " ")
space2 = markup.font("Inconsolata 2", " ")
...
-- Calendar
mytextcalendar = awful.widget.textclock(markup("#FFFFFF", space3 .. "%d %b<span font='Inconsolata 5'> </span>"))
...
mpdwidget = lain.widgets.mpd({
    settings = function ()
        if mpd_now.state == "play" then
            ...
            widget:set_markup(markup.font("Inconsolata 4", " ")
                              .. markup.font("Inconsolata 8", 
                              mpd_now.artist
                              .. " - " ..
                              mpd_now.title
                              .. markup.font("Inconsolata 10", " ")))
            play_pause_icon:set_image(beautiful.pause)
        elseif mpd_now.state == "pause" then
            widget:set_markup(markup.font("Inconsolata 4", " ") ..
                              markup.font("Inconsolata 8", "MPD PAUSED") ..
                              markup.font("Inconsolata 10", " "))
            play_pause_icon:set_image(beautiful.play)
        else
            widget:set_markup("")
...
netwidget = lain.widgets.net({
    settings = function()
        widget:set_markup(markup.font("Inconsolata 1", " ") .. net_now.received .. " - "
                          .. net_now.sent .. space2)
    end
})
...
-- Separators
first = wibox.widget.textbox('<span font="Inconsolata 4"> </span>')
